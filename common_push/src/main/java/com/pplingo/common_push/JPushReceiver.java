...
public  class JPushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(JPushInterface.ACTION_REGISTRATION_ID)) {
            ...
            JPushManager.getInstance().callBack.transmitReceiveRegistrationId(rId);
    ...
    private void handlingMessageReceive(Intent intent) {
        ...
        JPushManager.getInstance().callBack.transmitMessageReceive(msg, extras);
    }
    ...
    private void handlingNotificationOpen(Context context, Intent intent) {
        ...
        Map<String, Object> extras = getNotificationExtras(intent);
        JPushManager.getInstance().callBack.transmitNotificationOpen(title, alert, extras);
    ...
    private void handlingNotificationReceive(Context context, Intent intent) {
        ...
        String alert = intent.getStringExtra(JPushInterface.EXTRA_ALERT);
        Map<String, Object> extras = getNotificationExtras(intent);
        JPushManager.getInstance().callBack.transmitNotificationReceive(title, alert, extras);
    }
