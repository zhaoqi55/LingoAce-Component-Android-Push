...
import com.pplingo.common_push.manager.CommonPushManager;
...
/**
 * Created by ZhqoQi on 2021/2/24 17:03
 * E-Mail Address：550655294@qq.com
 */

public class JPushManager implements CommonPushManager {
    ...
    public static CommPushCallBack callBack;
    ...
    @Override
    public String getRegistrationID(Context conn) {
    ...
    @Override
    public void checkTag(Context conn, Set<String> Tags) {
    ...
    public void onTagOperatorResult(Context context, JPushMessage jPushMessage) {
        if (jPushMessage != null) {
            callBack.onTagOperateResult(transformJPushMessage(jPushMessage));
    ...
    public void onCheckTagOperatorResult(Context context, JPushMessage jPushMessage) {
        if (jPushMessage != null) {
            callBack.onTagCheckResult(transformJPushMessage(jPushMessage));
            int sequence = jPushMessage.getSequence();
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        if (jPushMessage != null) {
            callBack.onAliasOperatorResult(transformJPushMessage(jPushMessage));
            int sequence = jPushMessage.getSequence();
    ...
    /**
     * 将JpushMessage转换为CommonPushResultBean
     *
     * @param message
     * @return
     */
    private CommonPushResultBean transformJPushMessage(JPushMessage message) {
        CommonPushResultBean pushResultBean = new CommonPushResultBean();
        pushResultBean.alias = message.getAlias();
        pushResultBean.tags = message.getTags();
        pushResultBean.errorCode = message.getErrorCode();
        pushResultBean.mobileNumber = message.getMobileNumber();
        pushResultBean.sequence = message.getSequence();
        pushResultBean.isTagCheckOperator = message.isTagCheckOperator();
        pushResultBean.isTagCheckStateResult = message.getTagCheckStateResult();
